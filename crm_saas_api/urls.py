...
v1_patterns = [
    ...
    path("payments/create-alqaseh-session/", create_alqaseh_payment, name="create_alqaseh_payment"),
    path("payments/alqaseh-return/", alqaseh_return, name="alqaseh_return"),
    ...
    path("auth/impersonate-end/", impersonate_end, name="impersonate_end"),
