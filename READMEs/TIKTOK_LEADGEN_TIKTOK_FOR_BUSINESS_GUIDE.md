...
## دليل المشتركين (ما يفعله مشتركو الـ CRM)

للمشتركين (الشركات) الذين يريدون تفعيل TikTok في حسابهم فقط، دون التفاصيل التقنية للإدارة: **[دليل المشترك: ربط TikTok بالـ CRM](./TIKTOK_LEADGEN_SUBSCRIBER_GUIDE.md)**. يمكنك مشاركة هذا الملف أو نشره كصفحة مساعدة.
